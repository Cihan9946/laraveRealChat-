        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header" style="background-color: #E5E8E8;">
                    <h5 class="modal-title" style="font-weight: bold; font-size: 25px !important; ">Kullanıcı
                        Güncelle</h5>
                    ...
                    <form id="update_category_post" method="post">
                        ...
                        <div class="row mt-3 mb-4">
                            <div class="form-group mb-4 col-12">
                                <label class="mb-1" for="category_name" style="text-decoration: underline;">Rol
                                    Adı </label>
        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="page-header">
                    <h2 class="pageheader-title">Birim Listesi</h2>
                </div>
            </div>
        </div>
